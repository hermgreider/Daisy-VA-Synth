...
/**
 * A driver for the SSD1327 128x128 OLED displays connected via I2C  
 */
using SSD1327I2c128x128Driver
    = daisy::SSD1327Driver<128, 128, SSD1327I2CTransport>;
